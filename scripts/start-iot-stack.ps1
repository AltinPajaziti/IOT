# Start IoT infrastructure (Kafka + Cassandra + Kafka UI)
Write-Host "Starting IoT stack (Kafka, Cassandra, Kafka UI)..." -ForegroundColor Cyan
docker compose up -d
...
Write-Host "  3. (Optional) spark-submit spark-jobs/traffic_streaming.py for Spark demo"
